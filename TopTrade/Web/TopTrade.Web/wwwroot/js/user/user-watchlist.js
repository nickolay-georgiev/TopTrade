document.addEventListener('DOMContentLoaded', function () {
    ...
    function init() {
        ...
        document.querySelectorAll('.remove-stock button')
            .forEach(x => x.addEventListener('click', removeStockButton));
        ...
        async function addStockToWatchList(stock) {
            ...
            tr.querySelector('.remove-stock button').addEventListener('click', removeStockButton);
        ...
        async function removeStockButton() {
            var stockToRemove =
                this.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.querySelector('.stock-ticker').textContent;
            ...
            if (response.ok) {
                var allStocks = [...document.querySelectorAll('.stock-ticker')];
                allStocks.find(x => x.textContent == `${stockToRemove}`).parentElement.parentElement.parentElement.parentElement.remove()
            }
        }
